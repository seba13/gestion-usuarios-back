...
export class UserRepository {
  ...
  public async getByUsername(username: string): Promise<IUser[]> {
    const [row] = await this.promise.query(
      `SELECT id_usuario as idUsuario, em.id_empleado as idEmpleado, usuario, correo, contrasena, activo, rol ,fec_creacion as fecCreacion,p.rut, ultimo_acceso as ultimoAcceso 
      FROM usuarios u
